package simart.umby.android.pages.manajemen_inventaris.data_barang_aset.model

data class DataBarangAsetModel(
    var noInventaris: String? = null, var namaAset: String? = null, var deskripsiAset: String? = null,
    var spesifikasi: String? = null, var isAsetSPK: Boolean? = null, var noSPK: String? = null,
